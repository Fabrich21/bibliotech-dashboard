    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Explora nuestra colección completa</p>
        </div>
        <Button asChild>
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
                {libros.map((libro) => (
                  <Card key={libro._id} className="hover:shadow-lg transition-shadow">
                    <CardHeader>
                    ...
                    <CardContent className="space-y-2">
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-sm font-medium">{libro.rating.toFixed(1)}</span>
                      </div>
                      ...
                      <div className="pt-2 flex justify-between items-center text-sm">
                        ...
                        <span className="text-gray-500">{libro.prestamos} préstamos</span>
                      </div>
